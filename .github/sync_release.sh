...
UPSTREAM_REPO="https://github.com/MiSTer-devel/WonderSwan_MiSTer.git"
...
UPSTREAM_CORE_NAME=(WonderSwan)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(WonderSwan.qpf)
COMPILATION_OUTPUT=(output_files/WonderSwan.rbf)
